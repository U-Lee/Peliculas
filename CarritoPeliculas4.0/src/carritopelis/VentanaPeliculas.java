...
public class VentanaPeliculas extends javax.swing.JFrame {
    ...
    double total;   //Declaración de las variables globales que realizarán los cálculos de la cuenta
    int contadorPeli = 1;
    ...
    public void desahabilitaBotones() {
    ...
    private void añadirPeliculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_añadirPeliculaActionPerformed
        ...
        try {
            Pelicula pelicula = new Pelicula(verificaCodigoBarras(), cd.pedirTitulo(), cd.pedirActor(), cd.pedirGenero(), cd.pedirPrecio(), cd.predirPeliculasEnexistencia()); //Se mandan los atributos al constructor de la clase Peliculas para la creación del objeto.
            lista.add(pelicula);    //Se añade al ArrayList los datos de los atributos del objeto pelicula.
    ...
    private String verificaCodigoBarras() {
        ...
        JOptionPane.showMessageDialog(null, "Codigo de barras ya existente introduce uno diferente", "ERROR", JOptionPane.WARNING_MESSAGE);
        return verificaCodigoBarras();
    }
